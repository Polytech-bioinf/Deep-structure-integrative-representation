...
for epoch in range(n_epochs2):
    for data in data_loader_train:
        ...
        loss = loss_r + 1 * loss_e + 10 * loss_re - 20 * loss_ff
    ...
    if epoch % 10 == 0:
        ...
        np.savetxt("/Users/yangyan/Desktop/test/BIC/_param_comb/param2_" + str(10) + "/param3_" + str(20) + "/epoch_" + str(l) + "/matrix" + ".txt", np.c_[commonC],
                   fmt='%lf', delimiter='\t')
        torch.save(model.state_dict(), './models/BIC/param2_'+ str(10) + '/param3_' + str(20) + '/epoch_' + str(l*10) +'.pth')
        l = l + 1
